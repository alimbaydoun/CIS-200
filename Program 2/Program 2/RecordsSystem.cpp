...
void salaryEmpInput() {
	...
	cout << "Enter Employee First Name: "; cin >> firstName;
	emp->setFirstName(firstName);
	cout << "Enter Employee Last Name: "; cin >> lastName;
	emp->setLastName(lastName);

	cout << "Enter Employee SSN: "; cin >> ssn;
	emp->setSSN(ssn);
	cout << "Enter Employee Tax Rate: "; cin >> taxCode;
	emp->setTaxRateCode(taxCode);
	cout << "Enter Annual Salary: "; cin >> annualSalary;
...
void regularEmpInput() {
	...
	cout << "Enter the hours worked: "; cin >> hours;
	emp->setHoursWorked(hours);
	cout << "Enter overtime hours worked: "; cin >> overtime;
...
void agencyEmpInput() {
	...
	cout << "Enter the hours worked: "; cin >> hours;
	emp->setHoursWorked(hours);
	cout << "Enter the company name: "; cin >> companyName;
